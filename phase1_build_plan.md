...
- [x] In `renderEventContent`, append a third line (`line-clamp-1`, `opacity-60`, italic) showing `appt.notes` when present
- [x] Full text on hover via native `title` attribute
